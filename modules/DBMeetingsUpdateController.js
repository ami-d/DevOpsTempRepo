var DBMeetingsUpdateController = {
    find: function(wcs, successcallback, errorcallback) {
        wcs = wcs.replace("where ", "where CountryID='" + getCountryID() + "' AND ");
        com.kony.WeightWatchers.MeetingUpload.MeetingsUpdate.find(wcs, successcallback, errorcallback);
    },
    create: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.MeetingUpload.MeetingsUpdate.create(obj, successcallback, errorcallback, markForUpload);
    },
    createAll: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.MeetingUpload.MeetingsUpdate.createAll(obj, successcallback, errorcallback, markForUpload);
    },
    update: function(wcs, obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.MeetingUpload.MeetingsUpdate.update(wcs, obj, successcallback, errorcallback, markForUpload);
    }
}
