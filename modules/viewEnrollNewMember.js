...
function eventonClickDoneDOBPopUp() {
  ...
  //** End
    if(kony.application.getCurrentForm().id == frmTallyMeetingCashout.id){
		...
		if(popupDateOfBirth.lblHiddenVal.text == frmTallyMeetingCashout.lbl1stSlip.text)
    		frmTallyMeetingCashout.lblSlipDate1.text = dateStr;
    	else if(popupDateOfBirth.lblHiddenVal.text == frmTallyMeetingCashout.lbl2ndSlip.text)
    		frmTallyMeetingCashout.lblSlipDate2.text = dateStr;
    	else if(popupDateOfBirth.lblHiddenVal.text == frmTallyMeetingCashout.lbl3rdSlip.text)
    		frmTallyMeetingCashout.lblSlipDate3.text = dateStr;
