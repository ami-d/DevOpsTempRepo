...
syncUserID = "wwmegna";
syncPwd = "Welcome2016";
syncAppID = "MEGNARetail"; //"MEGQAT1";  //"MEGPRD";
syncServerHost = "weightwatchers-qa2.sync.konycloud.com"; //"weightwatchers-ds1.sync.konycloud.com";//"kony-ww-dbg1.sync.konycloud.com";//"14.141.118.66"; //"weightwatchers-qa1.sync.konycloud.com";//"weightwatchers.sync.konycloud.com";//"14.141.118.66";//
...
function syncStartSession(){
	...
	config.removeafterupload = {"MeetingSyncScope": ["Meetings"], "MemberSyncScope" : ["MemberDetails", "MilestoneAchieved","MilestoneEligible", "NoteDetails", "WeighDetails","RefferalDetails"]};
...
//	}MilestoneSyncScope,NoteSyncScope,WeightSyncScope
	...
	{
		config.removeafterupload = {"MeetingSyncScope": ["Meetings"], "MemberSyncScope" : ["MilestoneEligible", "NoteDetails","RefferalDetails"]};
	
		config.sessiontasks = {
			ProductSyncScope : {doupload : false, dodownload : true},	
			MeetingUpload : {doupload: true, dodownload : false, uploaderrorpolicy:"continueonerror"},		
			MemberSyncScope : {doupload: true, dodownload : true, uploaderrorpolicy:"continueonerror"},
			Tally : {doupload: false, dodownload : false},
			MeetingSyncScope : {doupload: false, dodownload : true},
			LookUpTables : {doupload: false, dodownload : false},
			Logger : {doupload: false, dodownload : false},
			TallySyncScope : {doupload: false, dodownload : false}
		};		
	}else if(isSyncForActivation){
		config.removeafterupload ={"MemberSyncScope" : ["MilestoneEligible", "NoteDetails","RefferalDetails"]};
		config.sessiontasks = {
			ProductSyncScope : {doupload : false, dodownload : false},
			MeetingUpload : {doupload: true, dodownload : false, uploaderrorpolicy:"continueonerror"},			
			MemberSyncScope : {doupload: true, dodownload : true, uploaderrorpolicy:"continueonerror"},
			Tally : {doupload: false, dodownload : false},
			MeetingSyncScope : {doupload: false, dodownload : false},
			LookUpTables : {doupload: false, dodownload : false},
			Logger : {doupload: false, dodownload : false},
			TallySyncScope : {doupload: false, dodownload : false}
		};
	}else if(isAWSAfterTallySync){
      config.removeafterupload = {};
	
		config.sessiontasks = {
			ProductSyncScope : {doupload : false, dodownload : false},
			MeetingUpload : {doupload: false, dodownload : false, uploaderrorpolicy:"continueonerror"},			
			MemberSyncScope : {doupload: false, dodownload : false, uploaderrorpolicy:"continueonerror"},
			Tally:{doupload: false, dodownload : false, uploaderrorpolicy:"continueonerror"},		
			MeetingSyncScope : {doupload: false, dodownload : true, uploaderrorpolicy:"continueonerror"},
			LookUpTables : {doupload: false, dodownload : false},
			Logger : {doupload: false, dodownload : false},
			TallySyncScope : {doupload: false, dodownload : false, uploaderrorpolicy:"continueonerror"}
		};
    }else
	{
		config.removeafterupload = {"MeetingSyncScope": ["Meetings"], "MemberSyncScope" : ["MilestoneEligible", "NoteDetails","RefferalDetails"]};
		...
		config.sessiontasks = {
			...
			MeetingUpload : {doupload: true, dodownload : false, uploaderrorpolicy:"continueonerror"},			
			MemberSyncScope : {doupload: true, dodownload : true, uploaderrorpolicy:"continueonerror"},
			Tally:{doupload: true, dodownload : false, uploaderrorpolicy:"continueonerror"},		
			MeetingSyncScope : {doupload: true, dodownload : true, uploaderrorpolicy:"continueonerror"},
			LookUpTables : {doupload: false, dodownload : false},
			Logger : {doupload: false, dodownload : false},
			TallySyncScope : {doupload: true, dodownload : false, uploaderrorpolicy:"continueonerror"}
		};
	}
	...
	config.filterparams = { 
		...
		ProductSyncScope : [ { ProductDetail : [ { Name : "LocationID", Value1 :  parseInt(glbLocationID)} ] },
							 { SKURuleEngine : [ { Name : "LocationNum", Value1 :  parseInt(glbLocationID)} ] }],		 
		MemberSyncScope : [ { MemberDetails : [ { Name : "LocationID", Value1 :  glbLocationID} ] },
							{ WeighDetails : [ { Name : "LocationID", Value1 :  glbLocationID} ] },
							{ MilestoneAchieved : [ { Name : "LocationNum", Value1 :  glbLocationID} ] }, 
							{ MilestoneEligible : [ { Name : "LocationNum", Value1 :  glbLocationID} ] },
							{ NoteDetails : [ { Name : "LocationID", Value1 :  glbLocationID} ] }],		
		MeetingSyncScope : [ { Meetings : [ { Name : "LocationID", Value1 :  glbLocationID} ] }]
	} ;
...
function onsyncerrorCallback(outputparams){
	...
	if(isFromTally)
	{
  	...
  	if(isAWSAfterTallySync)
      {
        
        isFromTally = false;
        isAWSAfterTallySync = false;
        alertForMessages(kony.i18n.getLocalizedString("strMsgTallySubmitSuccess")); //MEG-3665 changes
		navigateToMeetingScreen();
...
{
	try{
	 	var errorMsg = _.findWhere(syncErrorCode, {"errorCode": res.errorCode}).errorMessage;
