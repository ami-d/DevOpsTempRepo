...
function preRegisterdMember() {
    ...
    if (termMemberInfo.MemberType == MemberTypeEnum[7])
        frmEnrollReturningMember.hboxMemberSection1.setEnabled(false);
    else
        frmEnrollReturningMember.hboxMemberSection1.setEnabled(true);
...
function ProcessMember() {
	...
	frmProcessMember.lblWeightLossFocusInfo.text = termMemberInfo.WeightLossFocus;
