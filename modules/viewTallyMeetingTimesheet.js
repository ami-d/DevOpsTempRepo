...
function initAddTimePopUp() {
    ...
    if (checkValidString(popupAddTime.hidTallyTimesheetID.text))
        popupAddTime.hidTallyTimesheetID.text = 0;
    if (checkValidString(popupAddTime.lblEmployee.text))
        popupAddTime.lblEmployee.text = "";
    if (checkValidString(popupAddTime.hidEmployeeId.text))
        popupAddTime.hidEmployeeId.text = 0;
    if (checkValidString(popupAddTime.lblEmployeeNumber.text))
        popupAddTime.lblEmployeeNumber.text = "";
    ...
    if (checkValidString(popupAddTime.lblStartTime.text))
        popupAddTime.lblStartTime.text = ""; //glbSelectedMeetingStartTime;
    if (checkValidString(popupAddTime.lblEndTime.text))
        popupAddTime.lblEndTime.text = ""; //glbSelectedMeetingEndTime;
    if (checkValidString(popupAddTime.lblBreakStartTime.text))
        popupAddTime.lblBreakStartTime.text = "";
    if (checkValidString(popupAddTime.lblBreakEndTime.text))
        popupAddTime.lblBreakEndTime.text = "";
    ...
    if (in_array(deviceLocale,Countries["CA"]) && isSelMeetingOpenHours != true) //CA + meeting type= trade 
    {
      ...
      //MEG-7442  popupAddTime.hboxTraineeName.setVisibility(true);
...
function processTimesheetDBOperation() {
    ...
    if(popupAddTime.lblPosition.text == getLocalizedString("strReceptionist")) 
    	timesheetObj.EmpRole = empRoleEnum[1];
    else if(popupAddTime.lblPosition.text == getLocalizedString("strLeader")) 
    	timesheetObj.EmpRole = empRoleEnum[2];
