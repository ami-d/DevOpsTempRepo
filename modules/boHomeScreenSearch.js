...
var boHomeScreenSearch = {
        ...
        if (response.length > 0) {
              ...
              if(IsInfoSessionMeeting())
        	{
              ...
              var b = mapKeys(viewHomeScreen, {
                    ...
                    PreRegNumber: kony.sync.getString(v.PreRegNumber),
                    MtngOccrID: kony.sync.getString(v.MtngOccrID),
                	vbxProcessMember: {setEnable:true }
                });
                kony.print("First Name is : " + kony.sync.getString(v.FirstName));
                frmHomeScreen_SimpleSearch_temp.push(b);
            }
    ...
    getAdvancedSearchDataWSCallback: function(status, AdvanceSearchList, processOffline) {
        try {
            ...
            if (status == 400) {
                ...
                if (AdvanceSearchList["MembersList"] && AdvanceSearchList["MembersList"].length > 0) {
        ...
        if (response.length > 0 && isManualSearch) {
            for (var i in response) {
                ...
                var IsSelectedMemberExpired = false;
              	var IsMemberInGracePeriod = false;
                ...
                if ((((kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("strMPBuyNew")]).toUpperCase()) || ((kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("strMPRedeem")]).toUpperCase()))) {
                    IsSelectedMemberExpired = checkExpirationDate(kony.sync.getString(v.ExpirationDate));
                  	//RTB-126
                  	if(IsSelectedMemberExpired){
                      IsSelectedMemberExpired = checkGracePeriodByExpirationDate(v.ExpirationDate);
                      if(IsSelectedMemberExpired == false){
                        	IsMemberInGracePeriod = true;
                      }
                    }
                    if (!IsSelectedMemberExpired) imgMemberSubscriptionStatus = "icn_monthly_pass1.png";
                } else if ((checkUndefined(kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum["17 Week Pass-Buy New"]).toUpperCase()) ||
                    (checkUndefined(kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum["17 Week Pass-Redeem"]).toUpperCase())) {
                    imgMemberSubscriptionStatus = "icn_17_week_pass.png";
                } else if ((checkUndefined(kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("str20WkBuyNew")]).toUpperCase()) ||
                    (checkUndefined(kony.sync.getString(v.SubscriptnType)).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("str20WkRedeem")]).toUpperCase())) {
                ...
                if (expDate != undefined && expDate != null && checkValidString(expDate)) {
                ...
                if (isDuplicate) {
                    resDup = mapKeys(viewAdvancedSearchResultWithDuplicate, {
    					...
    					PlanType: kony.sync.getString(v.PlanType),
                      	IsGracePeriod: IsMemberInGracePeriod,
                      	WeightLossFocus: kony.sync.getString(v.WeightLossFocus)
                    });
    ...
    getMembersOfMeetingForHomeScreen: function(whereClause) {
  	...
  	//**MEG 7315
  	getMembersOfInfoSessionMeetingForHomeScreen: function(sql) {
      	var sqlQuery = sql;
        function getMembersOfInfoSessionMeetingForHomeScreenSuccessCallback(res) {
            kony.print("res.length==>>" + res.length);
        ...
        kony.sync.single_select_execute(kony.sync.getDBName(), sqlQuery, null, getMembersOfInfoSessionMeetingForHomeScreenSuccessCallback, eventErrorCallBack);
        //DBPreRegMemberDetailsController.find(whereClause, getMembersOfInfoSessionMeetingForHomeScreenSuccessCallback, eventErrorCallBack)
    },
	//**End	
    ...
    fillTermMemberInfoObject: function(res) {
        ...
        termMemberInfo.EmailID = (checkUndefined(res[0].EmailID) == "") ? "" : checkUndefined(res[0].EmailID);
      	termMemberInfo.WeightLossFocus = (checkUndefined(res[0].WeightLossFocus));
            ...
            if (response.length > 0) {
                ...
                for (var i1 = 0; i1 < AdvanceSearchList["MembersList"].length; i1++) {
                    ...
                    if ((AdvanceSearchList["MembersList"][i1]["RegStatus"]).toUpperCase() == (MemberRegEnum.Pre_Registered).toUpperCase()) {
                        ...
                        imgMemberRow = "icn_plus.png";
                        IsProductFlowFromSearch = false;
                    } else if ((AdvanceSearchList["MembersList"][i1]["RegStatus"]).toUpperCase() == (MemberRegEnum.Online).toUpperCase() ||
                        (AdvanceSearchList["MembersList"][i1]["RegStatus"]).toUpperCase() == (MemberRegEnum.Website).toUpperCase()) {
                        imgRegStatus = "icn_online_only_member.png";
                        imgMemberRow = "icn_plus.png";
                        IsProductFlowFromSearch = false;
                    }
                    ...
                    if (((checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("strMPBuyNew")]).toUpperCase()) || (checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("strMPRedeem")]).toUpperCase()))) {
                        IsSelectedMemberExpired = checkExpirationDate(AdvanceSearchList["MembersList"][i1]["ExpirationDate"]);
                      	...
                      	if(IsSelectedMemberExpired){
                        	if(isSubIdSearched){
                            	IsSelectedMemberExpired = checkGracePeriod(AdvanceSearchList["MembersList"][i1]["IsGracePeriod"]);
                              	IsMemberInGracePeriod = AdvanceSearchList["MembersList"][i1]["IsGracePeriod"]
                          	}else{
                            	IsSelectedMemberExpired = checkGracePeriodByExpirationDate(AdvanceSearchList["MembersList"][i1]["ExpirationDate"]);
                            	if(IsSelectedMemberExpired == false){
                                	IsMemberInGracePeriod = true;
                                }
                          	}
                        ...
                        if (!IsSelectedMemberExpired) imgMemberSubscriptionStatus = "icn_monthly_pass1.png";
                    } else if ((checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum["17 Week Pass-Buy New"]).toUpperCase()) ||
                        (checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum["17 Week Pass-Redeem"]).toUpperCase())) {
                        imgMemberSubscriptionStatus = "icn_17_week_pass.png";
                    } else if ((checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("str20WkBuyNew")]).toUpperCase()) ||
                        (checkUndefined(AdvanceSearchList["MembersList"][i1]["SubscriptnType"]).toUpperCase() == (MemberSubscriptionTypeEnum[kony.i18n.getLocalizedString("str20WkRedeem")]).toUpperCase())) {
                        imgMemberSubscriptionStatus = "icn_20_week_pass.png";
                    }
                    ...
                    if (isDuplicate) {
                        resDup = mapKeys(viewAdvancedSearchResultWithDuplicate, {
    						...
    						PlanType: AdvanceSearchList["MembersList"][i1]["PlanType"],
                          	IsGracePeriod: IsMemberInGracePeriod,
                          	WeightLossFocus: AdvanceSearchList["MembersList"][i1]["WeightLossFocus"]
                        });
    ...
    getMemberWeightDataWS: function(memberID) {
        try {
			...
			//** MEG 6493
		 	if(JsonService){
        		MemberWeightList_inputparam["httpheaders"] = setRESTHeader();
      		}else {
    ...
    getMemberWeightDataWSCallback: function(status, MembersWeightList, processOffline) {
        try {
            if (status == 400) {
                ...
                if (MembersWeightList["MemberWeightList"] && MembersWeightList["MemberWeightList"].length > 0) {
        ...
        if (res !== null) {
            for (var i in res) {
                ...
                obj.PlanType = res[i].PlanType;
              	//obj.IsGracePeriod = res[i].IsGracePeriod;
