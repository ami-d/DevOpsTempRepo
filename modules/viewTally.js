...
function setDefaultDateForSlip(noOfChecks) {
    ...
    if (noOfChecks == 3) {
        ...
        if (checkValidString(frmTallyMeetingCashout.lblSlipDate3.text))
            currDateThree = new Date(frmTallyMeetingCashout.lblSlipDate3.text);
        else
            currDateThree = new Date(currDateThree);
    ...
    if (checkValidString(frmTallyMeetingCashout.lblSlipDate1.text))
        currDateOne = new Date(frmTallyMeetingCashout.lblSlipDate1.text);
    ...
    if (checkValidString(frmTallyMeetingCashout.lblSlipDate2.text))
        currDateTwo = new Date(frmTallyMeetingCashout.lblSlipDate2.text);
    else
        currDateTwo = new Date(currDateTwo);
    kony.print("currDateTwo " + currDateTwo);
...
function eventonclickNavigatetoTimeSheet() {
    ...
    if (res) {
        ...
        } else if ((frmTallyMeetingCashout.txtCash.text != null && parseFloat(frmTallyMeetingCashout.txtCash.text) > 0 
        				|| frmTallyMeetingCashout.txtChecks.text != null && parseFloat(frmTallyMeetingCashout.txtChecks.text) > 0) 
        				|| (frmTallyMeetingCashout.txtBankDepositSlipNumber.text != "") 
        				|| ((frmTallyMeetingCashout.txtBankDepositSlip1No.text !=  undefined) && (frmTallyMeetingCashout.txtBankDepositSlip1No.text != "")) 
        				|| ((frmTallyMeetingCashout.txtBankDepositSlip2No.text !=  undefined) && (frmTallyMeetingCashout.txtBankDepositSlip2No.text != ""))
        				|| ((frmTallyMeetingCashout.txtBankDepositSlip3No.text !=  undefined) && (frmTallyMeetingCashout.txtBankDepositSlip3No.text != "")) ) {
...
function validateBankDepositSlipsForAWS(bankDepositNumber){
  	...
  	if(frmTallyMeetingCashout.hboxSplitBankSlip.isVisible == true){
        ...
        if(parseFloat(frmTallyMeetingCashout.lblMEGCash.text) > 0 || parseFloat(frmTallyMeetingCashout.lblMEGChecks.text) > 0 || 
          		(frmTallyMeetingCashout.txtCash.text != null && parseFloat(frmTallyMeetingCashout.txtCash.text) > 0 )
        				|| (frmTallyMeetingCashout.txtChecks.text != null && parseFloat(frmTallyMeetingCashout.txtChecks.text) > 0)){	
...
function eventonClickSlipDate(section){
    ...
    var widgetVal = "";
    if(section == frmTallyMeetingCashout.lbl1stSlip.text)
    	widgetVal = frmTallyMeetingCashout.hboxSlipDate1Section;
    else if(section == frmTallyMeetingCashout.lbl2ndSlip.text)
    	widgetVal = frmTallyMeetingCashout.hboxSlipDate2Section;
    else if(section == frmTallyMeetingCashout.lbl3rdSlip.text)
    	widgetVal = frmTallyMeetingCashout.hboxSlipDate3Section;
    var context1 = {
        "widget": widgetVal,
        "anchor": "right",
        "sizetoanchorwidth": true
    ...
    if (section == "") {
       ...
       if(section == frmTallyMeetingCashout.lbl1stSlip.text)
          eventinitDOBPopUp(frmTallyMeetingCashout.lblSlipDate1.text);
        else if(section == frmTallyMeetingCashout.lbl2ndSlip.text)
            eventinitDOBPopUp(frmTallyMeetingCashout.lblSlipDate2.text);
        else if(section == frmTallyMeetingCashout.lbl3rdSlip.text)
            eventinitDOBPopUp(frmTallyMeetingCashout.lblSlipDate3.text);
