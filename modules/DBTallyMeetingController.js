var DBTallyMeetingController = {
    find: function(wcs, successcallback, errorcallback) {
        wcs = wcs.replace("where ", "where CountryID='" + getCountryID() + "' AND ");
        com.kony.WeightWatchers.Tally.TallyMeeting.find(wcs, successcallback, errorcallback);
    },
    create: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.Tally.TallyMeeting.create(obj, successcallback, errorcallback, markForUpload);
    },
    createAll: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.Tally.TallyMeeting.createAll(obj, successcallback, errorcallback, markForUpload);
    ...
    update: function(wcs, obj, successcallback, errorcallback, markForUpload) {
        ...
        obj.Locale = deviceLocale.replace('_', '-');
        obj.CountryID = getCountryID();
        com.kony.WeightWatchers.Tally.TallyMeeting.update(wcs, obj, successcallback, errorcallback, markForUpload);
    }
