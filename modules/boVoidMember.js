...
var boVoidMember = {
   ...
   // kony.i18n.getLocalizedString("strAlertSimpleReturn")
    ...
    getPaymentForReturn: function(transaction, callback) {
     ...
     //** 7249
        var transactionSQLQuery = "SELECT S.SubsidyAmount as SubsidyAmount,(select count(1) from saleitems WHERE SaleTransactnId ='" + transaction + "' and IsSaleItemVoid = '1') as Partial, " +
            ...
            "INNER JOIN SaleDetails S ON S.SaleTransactnId = A.SaleTransactnId" + 
