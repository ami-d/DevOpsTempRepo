/*
  * kony-sdk-ide Version SDK-GA-7.2.1.23
  */
...
kony.sdk.version = "SDK-GA-7.2.1.23";
...
kony.sdk.setLicenseCall = function(appKey,appSecret,data){
		...
		if(typeof(appConfig) != "undefined") {
			...
			//Checking for duplicate license call, if new appkey, appSecret and ServiceURL 
			if ((appKey != appConfig.appKey) || (appSecret != appConfig.appSecret) || (appConfig.serviceUrl != data.selflink)) {
				//Appconfig is set with new values and IST call is triggered.
