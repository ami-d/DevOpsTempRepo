    ...
    addUpdateActivationDetailsToLocalDB: function(memberActivationInfoObj, callBack) {
        ...
        function getMemberActivationAlreadyExistsCallBack(res) {
            ...
            if (res.length > 0) {
                ...
                memberActivationInfoObj_create.ActivationDate = _.find(memberActivationInfo, function(MemberActivation) {
                    return 'LastUsedDate' in MemberActivation
                }).LastUsedDate;
                memberActivationInfoObj_create.ActivationStatus = memberActivationStatus;
                memberActivationInfoObj_create.PassDuration = _.find(memberActivationInfo, function(MemberActivation) {
                    return 'ProgramDuration' in MemberActivation
                }).ProgramDuration;
                memberActivationInfoObj_create.PassType = _.find(memberActivationInfo, function(MemberActivation) {
                    return 'SubscriptionType' in MemberActivation
                }).SubscriptionType;
                memberActivationInfoObj_create.CouponCode = couponCode;
                memberActivationInfoObj_create.ExpirationDate = _.find(memberActivationInfo, function(MemberActivation) {
                    return 'ExpirationDate' in MemberActivation
                }).ExpirationDate;
                memberActivationInfoObj_create.PreactivationDate = _.find(memberActivationInfo, function(MemberActivation) {
                    return 'CreatedDate' in MemberActivation
                }).CreatedDate;
