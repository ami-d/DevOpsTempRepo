...
function ProcessMemberAfterSearch() {
    ...
    //AMi add MEG-3147
    if (isTermedMemberForActive) selectedData["MemberStatus"] = MemberStatusEnum[1];
    //Ami add- MEG-3147
    //Ami add-MEG-3798
...
function setSortFlagAdvResult() {
    if (isSortAscendingAdv == true) isSortAscendingAdv = false;
    else isSortAscendingAdv = true;
...
function checkGracePeriod(isGracePeriod) {
    ...
    if (isGracePeriod == true) return false;
    else return true;
}
