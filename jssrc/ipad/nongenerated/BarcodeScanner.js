                ...
                if (!isNaN(data)) {
                    ...
                    //Added by Shobhit to differentiate flow
                        ...
                        if (data.indexOf(".") != -1) {
                            ...
                            if (bankDepositSlip == frmTallyMeetingCashout.lbl1stSlip.text) frmTallyMeetingCashout.txtBankDepositSlip1No.text = data;
                            else if (bankDepositSlip == frmTallyMeetingCashout.lbl2ndSlip.text) frmTallyMeetingCashout.txtBankDepositSlip2No.text = data;
                            else if (bankDepositSlip == frmTallyMeetingCashout.lbl3rdSlip.text) frmTallyMeetingCashout.txtBankDepositSlip3No.text = data;
                            else frmTallyMeetingCashout.txtBankDepositSlipNumber.text = data;
                        }
