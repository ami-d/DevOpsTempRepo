...
// ****************Generated On Wed Mar 28 06:54:25 UTC 2018TallySummary*******************
...
com.kony.WeightWatchers.TallySyncScope.TallySummary = function() {
    ...
    this.ThreeMonthsPassesLTCActivated = null;
    this.PreRegMemberCount = null;
...
com.kony.WeightWatchers.TallySyncScope.TallySummary.prototype = {
    ...
    get ThreeMonthsPassesLTCActivated() {
        return this._ThreeMonthsPassesLTCActivated;
    },
    set ThreeMonthsPassesLTCActivated(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)) {
            sync.log.error("Invalid data type for the attribute ThreeMonthsPassesLTCActivated in TallySummary.\nExpected:\"int\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._ThreeMonthsPassesLTCActivated = val;
    },
    get PreRegMemberCount() {
        return this._PreRegMemberCount;
    },
    set PreRegMemberCount(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)) {
            sync.log.error("Invalid data type for the attribute PreRegMemberCount in TallySummary.\nExpected:\"int\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._PreRegMemberCount = val;
    },
};
/************************************************************************************
 ...
 *		valuesArray[0].ThreeMonthsPassesLTCActivated = 0;
 *		valuesArray[0].PreRegMemberCount = 0;
 *		valuesArray[1] = {};
 *		valuesArray[1].Id = 1;
 ...
 *		valuesArray[1].ThreeMonthsPassesLTCActivated = 1;
 *		valuesArray[1].PreRegMemberCount = 1;
 *		valuesArray[2] = {};
 *		valuesArray[2].Id = 2;
 ...
 *		valuesArray[2].ThreeMonthsPassesLTCActivated = 2;
 *		valuesArray[2].PreRegMemberCount = 2;
...
com.kony.WeightWatchers.TallySyncScope.TallySummary.convertTableToObject = function(res) {
    ...
    if (res !== null) {
        for (var i in res) {
            ...
            obj.ThreeMonthsPassesLTCActivated = res[i].ThreeMonthsPassesLTCActivated;
            obj.PreRegMemberCount = res[i].PreRegMemberCount;
...
com.kony.WeightWatchers.TallySyncScope.TallySummary.filterAttributes = function(valuestable, insert) {
    ...
    attributeTable.ThreeMonthsPassesLTCActivated = "ThreeMonthsPassesLTCActivated";
    attributeTable.PreRegMemberCount = "PreRegMemberCount";
    var PKTable = {};
    PKTable.Id = {}
    PKTable.Id.name = "Id";
...
com.kony.WeightWatchers.TallySyncScope.TallySummary.prototype.getValuesTable = function(isInsert) {
    ...
    valuesTable.ThreeMonthsPassesLTCActivated = this.ThreeMonthsPassesLTCActivated;
    valuesTable.PreRegMemberCount = this.PreRegMemberCount;
    return valuesTable;
};
...
com.kony.WeightWatchers.TallySyncScope.TallySummary.checkPKValueTables = function(valuetables) {
