...
var error = '';
var validPasskey = ["1-1-1", "1-1-2", "1-2-1", "1-2-2", "8-1-1", "10-1-1", "13-1-1", "14-1-1", "15-1-1"]; //, '9-1-1', '9-2-1' // MEGCA-290 //** MEG 6434
var minDPT = 1;
var maxDPT = 999;
...
function formatDate(date) {
    ...
    try {
        ...
        kony.print(" formatDate month " + month);
        month = month.replace('"', ""); //**MEG 7118
        kony.print(" formatDate month after replace " + month);
...
function validEmail(email) {
    try {
        var emailPattern = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\u00C0-\u017F\u00AA\u00BA\-0-9]+\.)+[a-zA-Z\u00C0-\u017F\u00AA\u00BA]{2,}))$/;
...
validationcls.prototype.CheckPhone = function(inputstr) {
    ...
    //** MEG 7312
validationcls.prototype.CheckTenDigitPhone = function(inputstr) {
    try {
        var phoneno = /^[0-9]{10}$/;
        if (phoneno.test(inputstr) && checkValidString(inputstr)) {
            return this;
        } else {
            error += kony.i18n.getLocalizedString("strMsgSearchPhoneValid");
            error += "\r";
            isvalid = false;
            return this;
        }
...
validationcls.prototype.validateAdvanceSearchString = function(str) {
        try {
            ...
            if (str != undefined && str != null && str != "") {
                ...
                if (pattern.test(str) || validEmail(str)) {
...
validationcls.prototype.validateAdvanceSearchFNameLName = function(str) {
    try {
        ...
        if (str != undefined && str != null && str != "") {
            ...
            if (pattern.test(str.trim()) || validEmail(str)) {
                kony.print("second if===>>>" + str);
                return this;
            } else {
                kony.print("second else===>>>" + str);
        ...
        try {
            if (lblinfo != null && lblinfo != undefined && lblinfo != "") {
                if (passKey != null && passKey != undefined && passKey != "") {
                    ...
                    if (passKey == "1-1-1" || passKey == "1-1-2" || passKey == "8-1-1" || passKey == "10-1-1" || passKey == "13-1-1" || passKey == "15-1-1") {
                        if (email != null && email != undefined && email != "") {
                            if (validEmail(email)) {
                                return this;
                            } else {
...
validationcls.prototype.checkforValidWeightDate = function(startdate) {
    ...
    // Validate Minor Members for MP-1,3,6 pass, 6 month LTC
validationcls.prototype.validateMinorForMP = function(subscriptionType, birthDate) {
    try {
        ...
        var subscriptions = [kony.i18n.getLocalizedString("strMPBuyNew"), kony.i18n.getLocalizedString("str3MPBuy"), kony.i18n.getLocalizedString("str6MPBuy"), kony.i18n.getLocalizedString("strMPRedeem"), kony.i18n.getLocalizedString("strLTC6"), kony.i18n.getLocalizedString("strLTC3"), kony.i18n.getLocalizedString("strAWSEnroll"), kony.i18n.getLocalizedString("strAWSContinue"), kony.i18n.getLocalizedString("strAWSRedeem"), kony.i18n.getLocalizedString("strAWSMaintenance"), kony.i18n.getLocalizedString("strAWSBridge")]; //MEG-6957
            ...
            if (in_array(deviceLocale, Countries["CA"])) {
                ...
                switch (memberflow) {
                    case 1:
                        dropdownData = [
                            [
                                ["1-1-1", kony.i18n.getLocalizedString("strMPBuyNew")],
                                ["8-1-1", kony.i18n.getLocalizedString("str3MPBuy")],
                                ["15-1-1", kony.i18n.getLocalizedString("strLTC3")], //** MEG-6957
                                //["10-1-1", kony.i18n.getLocalizedString("str6MPBuy")],//MEG-6592
                                ["13-1-1", kony.i18n.getLocalizedString("strLTC6")], //** MEG 6434 //MEG-6592
                    ...
                    case 9:
                        dropdownData = [
                            [
                                ["12-4-1", kony.i18n.getLocalizedString("strAWSEnroll")],
                                ["12-4-2", kony.i18n.getLocalizedString("strAWSContinue")],
                                ["12-2-1", kony.i18n.getLocalizedString("strAWSRedeem")],
                                ["12-6-2", kony.i18n.getLocalizedString("strAWSBridge")],
                                ["12-7-2", kony.i18n.getLocalizedString("strAWSMaintenance")],
                                ["3-1-1", kony.i18n.getLocalizedString("strPayg")], 60
                            ]
                        ]
                        break;
                    case 10:
                        dropdownData = [
                            [
                                ...
                                ["12-6-2", kony.i18n.getLocalizedString("strAWSBridge")],
                                ["12-7-2", kony.i18n.getLocalizedString("strAWSMaintenance")],
                                ["3-2-2", kony.i18n.getLocalizedString("strPayg")], 60
                            ]
                        ]
                        break;
                    case 11:
                        dropdownData = [
                            [
                                ["1-2-1", kony.i18n.getLocalizedString("strMonthlyPass")],
                                ["3-1-1", kony.i18n.getLocalizedString("strPayg")],
                                ["12-1-1", kony.i18n.getLocalizedString("strSeries")], 60
                            ]
                        ];
                        break;
                }
...
function bindMeetingDataToDropdown(meetingData, TalliedMeetingData) {
    ...
    var bindMeetingData = [];
    var bindMorningMeetingDataHomeScreen = [];
    var bindAfternoonMeetingDataHomeScreen = [];
    ...
    if (meetingData.length > 0) {
        ...
        for (var i in meetingData) {
            ...
            kony.print("meetingObj.IsAtWork" + meetingObj.IsAtWork);
            kony.print("isWeek " + isWeek);
            kony.print("meetingObj.SeriesCompMeetings " + meetingObj.SeriesCompMeetings);
            if (!glbIsWeekChanged) {
                meetingObj.meetingWeekNo += 1;
            }
            var weekNo = "0";
            /* if((meetingObj.IsAtWork == true || meetingObj.IsAtWork == 'true')){            
                    isWeek = true;
               	 weekNo = parseInt(meetingObj.SeriesCompMeetings)+1;
              
                 }else { 
                      isWeek = false;
               }; */
            kony.print("meetingObj.IsTallySubmitted " + meetingObj.IsTallySubmitted);
            if ((meetingObj.IsAtWork == true || meetingObj.IsAtWork == 'true')) {
                isWeek = true;
                if (meetingObj.IsTallySubmitted == true || meetingObj.IsTallySubmitted == 'true') //** MEG 7154
                    weekNo = parseInt(meetingObj.SeriesCompMeetings)
                else weekNo = parseInt(meetingObj.SeriesCompMeetings) + 1;
            } else {
                isWeek = false;
            };
            kony.print("bindMeetingDataToDropdown weekNo==" + weekNo);
            if (meetingObj.meetingStatus == "Open") {
                bindMeetingData.push({
                    "meetingName": meetingObj.lblMeetings,
                    "weekNumber": ("17" === meetingObj.meetingTypeID) ? {
                        "text": "week: " + weekNo,
                        "isVisible": false
                    } : {
                        "text": "week: " + weekNo,
                    ...
                    "meetingStartDate": meetingObj.meetingStartDate,
                    ...
                    "LineOfBsinessID": meetingObj.LineOfBsinessID,
                    "IsAtWork": meetingObj.IsAtWork,
                    "SeriesCompMeetings": meetingObj.SeriesCompMeetings,
                    "IsTallySubmitted": meetingObj.IsTallySubmitted, //**MEG 7172
                    "IsInfoSession": meetingObj.IsInfoSession
                });
                var dt = meetingObj.meetingDate.split('T')[1].split('-')[0];
                var hour = dt.split(':')[0];
                kony.print('----------meetingObj.meetingDate---------' + meetingObj.meetingDate + '-----dt---------' + dt + '-----hour----' + hour);
                if (hour < 12) {
                    bindMorningMeetingDataHomeScreen.push({
                        ...
                        "IsTallySubmitted": meetingObj.IsTallySubmitted, //**MEG 7172
                        "IsInfoSession": meetingObj.IsInfoSession,
                        "lineSegment": (i == bindMorningMeetingDataHomeScreen.length - 1) ? {
                            "isVisible": false
                        } : {
                            "isVisible": true
                        },
                    ...
                    bindAfternoonMeetingDataHomeScreen.push({
                        "lblMeetings": meetingObj.lblMeetings,
                        "weekNumber": ("17" === meetingObj.meetingTypeID) ? {
                            "text": "week: " + weekNo,
                            "isVisible": false
                        ...
                        "IsTallySubmitted": meetingObj.IsTallySubmitted, //**MEG 7172
                        "IsInfoSession": meetingObj.IsInfoSession,
                        "lineSegment": (i == bindAfternoonMeetingDataHomeScreen.length - 1) ? {
                            "isVisible": false
                        } : {
                            "isVisible": true
                        },
                ...
                if ((meetingObj.IsAtWork == true || meetingObj.IsAtWork == 'true')) {
                    //check for the weeknumber in Meetings table to make sure tally is submitted from the same device and hence no need to add +1 to week number
                    boMeetings.getWeekNoForAtWorkMeetingClosed(meetingObj.meetingNum, meetingObj.meetingDate, function(weekNoFromClosedMeeting) { // get the week number from meeting close table
                        kony.print("getWeekNoForAtWorkMeetingClosed weekNoFromClosedMeeting=" + weekNoFromClosedMeeting);
                        if (parseInt(weekNoFromClosedMeeting) != 0) //if meeting close weeknumber is equal to the weeknumber from meeting getall meaning all tally submitted from all devices
                        {
                            weekNo = parseInt(weekNoFromClosedMeeting);
                        } else { // chck exact week from start date to the current date
                            /*var weeks = Math.round((new Date() - new Date(meetingObj.meetingStartDate))/ 604800000);
                            kony.print("getWeekNoForAtWorkMeetingClosed week in between="+weeks);
                            if(weeks = parseInt(meetingObj.SeriesCompMeetings))
                            {*/
                            weekNo = parseInt(meetingObj.SeriesCompMeetings);
                            //    }
                        }
                ...
                kony.print("getWeekNoForAtWorkMeetingClosed 111 weekNo=" + weekNo);
                ...
                bindCloseMeetingData.push({
                    "lblMeetings": meetingObj.lblMeetings,
                    "weekNumber": {
                        "text": "week: " + weekNo, //parseInt(meetingObj.SeriesCompMeetings),
                        "isVisible": false
                    },
                    "meetingName": meetingObj.lblMeetings,
                    "meetingTime": meetingObj.meetingTime,
    ...
    kony.print("frmSelectMeeting HOME OPEN===>> " + JSON.stringify(bindMorningMeetingDataHomeScreen));
    kony.print("frmSelectMeeting HOME OPEN===>> " + JSON.stringify(bindAfternoonMeetingDataHomeScreen));
    ...
    if (bindMorningMeetingDataHomeScreen.length == 0) {
        bindMorningMeetingDataHomeScreen.pop();
        bindMorningMeetingDataHomeScreen.push({
            "meetingName": getLocalizedString("strNoMorningMeetings"), //"No Morning Meetings",
            "btnOpen": {
                "isVisible": false
            },
            "weekNumber": {
    ...
    if (bindAfternoonMeetingDataHomeScreen.length == 0) {
        bindAfternoonMeetingDataHomeScreen.pop();
        bindAfternoonMeetingDataHomeScreen.push({
            "meetingName": getLocalizedString("strNoAfternoonMeetings"), //"No Afternoon Meetings",
            "btnOpen": {
                "isVisible": false
            },
            "weekNumber": {
    ...
    if (isCurrentMeetingDropdown) {
        ...
        var morningMeetingOpenTitle = "  " + kony.i18n.getLocalizedString("strOpenMorningMeetingTittle"); //"  Morning Scheduled Meetings";
        var afternoonMeetingOpenTitle = "  " + kony.i18n.getLocalizedString("strOpenAfternoonMeetingTittle"); //"  Afternoon Scheduled Meetings";
        ...
        frmSelectMeeting.segMeetingsList.data = [
            [morningMeetingOpenTitle, bindMorningMeetingDataHomeScreen],
            [afternoonMeetingOpenTitle, bindAfternoonMeetingDataHomeScreen],
            [closeMeetingTitle, bindCloseMeetingData]
        ]
        kony.print('-------------segment data--->>' + JSON.stringify(frmSelectMeeting.segMeetingsList.data));
    }
...
function bindSateDataToDropdown(stateData, isRefineSearch) {
    ...
    if (stateData.length > 0) {
        for (var i in stateData) {
            ...
            if (stateObj.StateABBR != "") bindStatesData.push(newstateObj);
        }
    }
