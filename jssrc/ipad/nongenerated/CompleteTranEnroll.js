function createEnrollMemberData(createMemberDetailsObject, entryDate) {
    ...
    //RTB-218
    createMemberDetailsObject.WeightLossFocus = (frmEnrollNewMember.switchWeightLossFocus.selectedIndex == "0") ? true : false;
...
function setEnrollSubcriptionData(createMemberDetailsObject, updatedEmailFromMPActivated, entryDate, flow) {
    kony.print("ABA ---> setEnrollSubcriptionData createMemberDetailsObject " + JSON.stringify(createMemberDetailsObject));
    kony.print("setEnrollSubcriptionData saleTransactionObj " + JSON.stringify(saleTransactionObj));
