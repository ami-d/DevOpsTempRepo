...
function getDollerPriceValue(Flow, membertype, selectKey, birthdate, weightDiff, missedWeekCnt, isPrepaid, isOverride) {
    ...
    try {
        ...
        if (selectKey == "") res = valid.checkForRequiredFields(membertype, "Membertype").checkForRequiredFields(Flow, "flow").validateDate(birthdate).isValid();
        else res = valid.checkForRequiredFields(membertype, "Membertype").checkForRequiredFields(selectKey, "selectKey").checkForRequiredFields(Flow, "flow").validateDate(birthdate).isValid();
