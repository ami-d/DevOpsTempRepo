...
// ****************Generated On Mon Oct 08 06:11:01 UTC 2018SKURuleEngine*******************
...
com.kony.WeightWatchers.ProductSyncScope.SKURuleEngine.prototype = {
    ...
    set LineOfBusiness(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)) {
            sync.log.error("Invalid data type for the attribute LineOfBusiness in SKURuleEngine.\nExpected:\"int\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._LineOfBusiness = val;
    },
    get SeriesLength() {
    ...
    set SeriesLength(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)) {
            sync.log.error("Invalid data type for the attribute SeriesLength in SKURuleEngine.\nExpected:\"int\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._SeriesLength = val;
    },
    get WeeksLeft() {
        return this._WeeksLeft;
    },
    set WeeksLeft(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)) {
            sync.log.error("Invalid data type for the attribute WeeksLeft in SKURuleEngine.\nExpected:\"int\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._WeeksLeft = val;
    },
    get IsExtended() {
    ...
    get AllowPriceOverride() {
        return kony.sync.getBoolean(this._AllowPriceOverride) + "";
    },
    set AllowPriceOverride(val) {
        if (!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidBooleanType(val)) {
            sync.log.error("Invalid data type for the attribute AllowPriceOverride in SKURuleEngine.\nExpected:\"boolean\"\nActual:\"" + kony.type(val) + "\"");
        }
        this._AllowPriceOverride = val;
    },
};
/************************************************************************************
 ...
 *		valuesArray[0].LineOfBusiness = 0;
 *		valuesArray[0].SeriesLength = 0;
 *		valuesArray[0].WeeksLeft = 0;
 *		valuesArray[0].IsExtended = "IsExtended_0";
 *		valuesArray[0].AllowPriceOverride = true;
 *		valuesArray[1] = {};
 ...
 *		valuesArray[1].LineOfBusiness = 1;
 *		valuesArray[1].SeriesLength = 1;
 *		valuesArray[1].WeeksLeft = 1;
 *		valuesArray[1].IsExtended = "IsExtended_1";
 *		valuesArray[1].AllowPriceOverride = true;
 *		valuesArray[2] = {};
 ...
 *		valuesArray[2].LineOfBusiness = 2;
 *		valuesArray[2].SeriesLength = 2;
 *		valuesArray[2].WeeksLeft = 2;
 *		valuesArray[2].IsExtended = "IsExtended_2";
 *		valuesArray[2].AllowPriceOverride = true;
...
com.kony.WeightWatchers.ProductSyncScope.SKURuleEngine.convertTableToObject = function(res) {
    ...
    if (res !== null) {
        for (var i in res) {
            ...
            obj.LineOfBusiness = res[i].LineOfBusiness;
            obj.SeriesLength = res[i].SeriesLength;
            obj.WeeksLeft = res[i].WeeksLeft;
            obj.IsExtended = res[i].IsExtended;
            obj.AllowPriceOverride = res[i].AllowPriceOverride;
...
com.kony.WeightWatchers.ProductSyncScope.SKURuleEngine.filterAttributes = function(valuestable, insert) {
    ...
    attributeTable.LineOfBusiness = "LineOfBusiness";
    attributeTable.SeriesLength = "SeriesLength";
    attributeTable.WeeksLeft = "WeeksLeft";
    attributeTable.IsExtended = "IsExtended";
    attributeTable.AllowPriceOverride = "AllowPriceOverride";
    var PKTable = {};
    PKTable.Id = {}
    PKTable.Id.name = "Id";
...
com.kony.WeightWatchers.ProductSyncScope.SKURuleEngine.prototype.getValuesTable = function(isInsert) {
    ...
    valuesTable.LineOfBusiness = this.LineOfBusiness;
    valuesTable.SeriesLength = this.SeriesLength;
    valuesTable.WeeksLeft = this.WeeksLeft;
    valuesTable.IsExtended = this.IsExtended;
    valuesTable.AllowPriceOverride = this.AllowPriceOverride;
    return valuesTable;
};
...
com.kony.WeightWatchers.ProductSyncScope.SKURuleEngine.checkPKValueTables = function(valuetables) {
