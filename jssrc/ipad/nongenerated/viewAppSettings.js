...
var Settings = {
    ...
    "AppMsg": "APP MESSAGES",
    "NDPT": "NEW DSP FORMULA",
    "NMILESTONE": "NEW FIVE AND TEN LB MILESTONE",
    "WDSAppMsg": "NEW WDS APP MESSAGES"
};
    ...
    try {
        if (status == 400) {
            if (getAppSettingResult["opstatus"] == 0) {
                if (getAppSettingResult["AppSettings"] && getAppSettingResult["AppSettings"].length > 0) { //** MEG 6493
                    removeProgressView();
