...
function closeTallyMeetingsuccess(status) {
    if (status) {
        ...
        //Ami - MEG-7287  boTallyMeetingReport.createTallySummary(createTallySummarysuccess);
        boTallyMeetingReport.removeCreateTallySummary(createTallySummarysuccess);
    }
}
/*Commented by Ami
...
function DisplayTallyMettingReportData() {
    if (in_array(deviceLocale, Countries["CA"])) {
        ...
        frmTallyMeetingReport.hboxThreeMonthLTCPass.setVisibility(false);
        frmTallyMeetingReport.hbox3MpLTCActivated.setVisibility(false);
    } else {
        ...
        frmTallyMeetingReport.hboxSixMonthPass.isVisible = false; //false; //MEG-6592
        frmTallyMeetingReport.hboxMPactivated.isVisible = true;
        frmTallyMeetingReport.hbox3MpActivated.isVisible = true;
        frmTallyMeetingReport.hbox6MPactivated.isVisible = false; //MEG-6592
        frmTallyMeetingReport.hboxSixMonthLTCPass.setVisibility(true); //MEG-6592 MEG-6646
        frmTallyMeetingReport.hbox6MPLTCactivated.setVisibility(true); //MEG-6592
        frmTallyMeetingReport.hboxThreeMonthLTCPass.setVisibility(true); //MEG-6955
        frmTallyMeetingReport.hbox3MpLTCActivated.setVisibility(true); //MEG-6955
    }
    try {
        ...
        function DisplayTallyMettingReportSuccessCallback(status, result) {
            if (status) {
                ...
                if (checkAppSettingEnable(Settings["NMILESTONE"])) {
                    frmTallyMeetingReport.hbox1388753862433562.isVisible = false;
                    frmTallyMeetingReport.hbox1388753862433550.isVisible = false;
                    frmTallyMeetingReport.hbox1388753862433598.skin = "hboxLightGrey";
                } else {
                    frmTallyMeetingReport.hbox1388753862433562.isVisible = true;
                    frmTallyMeetingReport.hbox1388753862433550.isVisible = true;
                    frmTallyMeetingReport.hbox1388753862433598.skin = "";
                }
                ...
                frmTallyMeetingReport.lbl3MonthLTCPass.text = result["Section3Num3MonthLTCPassSold"]; //MEG-6955
                frmTallyMeetingReport.lblThreeMPLTCActiveCount.text = result["Section3NumThreeMPsLTCActivationSold"]; //MEG-6955
