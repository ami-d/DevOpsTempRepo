function addWidgetspopupNumberOfBanks() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094488_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094488_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var lblUpdateBanks = new kony.ui.Label({
        ...
        "isVisible": true,
        "skin": "lblNormal",
        "text": kony.i18n.getLocalizedString("strlblupdatebanks")
    }, {
        "containerWeight": 100,
    ...
    var pickerBanks = new kony.ui.PickerView({
        "id": "pickerBanks",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    popupNumberOfBanks.add(hboxHeaderSection, hboxLabelUpdate, lineHeader, pickerBanks, line13932202681379065);
};

function popupNumberOfBanksGlobals() {
    popupNumberOfBanks = new kony.ui.Popup({
        "addWidgets": addWidgetspopupNumberOfBanks,
        "id": "popupNumberOfBanks",
        "isModal": false,
        "skin": "frm",
