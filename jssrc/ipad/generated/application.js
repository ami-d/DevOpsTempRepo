...
_invokeServiceAsyncForMF_ = function(url, inputParam, callBack) {
    ...
    if (!operationID) {
        ...
        var _mfServicesMap_ = {
            "ActivityLogInsertREST": {
                "servicename": "MEGNARetailService0"
            },
            "AuthorizeServiceREST": {
                "servicename": "MEGNARetailService0"
            },
            "CybersourceTransactionLogREST": {
                "servicename": "MEGNARetailService0"
            },
            "GetAppSettingREST": {
                "servicename": "MEGNARetailService0"
            ...
            "PeripheralStatusLogREST": {
                "servicename": "MEGNARetailService0"
            },
            "GetPeripheralInfoREST": {
                "servicename": "MEGNARetailService0"
            },
            "PeripheralInfoUpdateREST": {
                "servicename": "MEGNARetailService0"
            },
            "PreActivateREST": {
                "servicename": "MEGNARetailService0"
            },
            "RegNumberValidateREST": {
                "servicename": "MEGNARetailService0"
            },
            "SaleReceiptREST": {
                "servicename": "MEGNARetailService0"
            ...
            "searchMemberForDuplicateMP": {
                "servicename": "MEGNARetailService0"
            },
            "TallyTimesheetSearchREST": {
                "servicename": "MEGNARetailService0"
            },
            "GetAppVersionDetailsREST": {
                "servicename": "MEGNARetailService0"
            },
            "GetMeetings": {
                "servicename": "MEGNARetailService0"
            ...
            "GetActivationStatus": {
                "servicename": "MEGNARetailService1"
            },
            "runTranBillingWithToken": {
                "servicename": "MEGNARetailService2"
            },
            "runTransaction": {
                "servicename": "MEGNARetailService2"
            },
            ...
            "MeetingTallyJSON": {
                "servicename": "MEGNARetailService3"
            },
            "MemberWeightAndMilestoneREST": {
                "servicename": "MEGNARetailService4"
            }
        };
...
function setAppHeadersAndFooters() {
    kony.application.setAppHeaders([hboxNameSection, hboxPhoneSection, hboxUserIdSection, hboxMemberIdSection, hboxName, hboxMemberIDSection, hboxPhoneNumberSection, hboxUserIDSection, hbxMain, hboxMainMemberProfile, hboxEnrollHdrMain, hboxHomeScreen, hboxMeetingSummery, hboxHomeScreenHeader, hboxHeaderWithCancelBtn, hboxNoMeetingHeader, hbox1393220268308995]);
    kony.application.setAppFooters([hboxTopAddFooter, hboxAddFooter, hboxTopEnrollFooter, hboxEnrollFooter, hboxTopMemberProcess, hboxProcessMember]);
}