function addWidgetspopupMemberStatus() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094237_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094237_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerMemberStatus = new kony.ui.PickerView({
        "id": "pickerMemberStatus",
        "isVisible": true,
        "masterData": [
            [
                ["0", "All"],
    ...
    hbox13932202681329026.add(pickerMemberStatus);
    ...
    popupMemberStatus.add(hboxHeaderSection, lineHeader, hbox13932202681329026, line13932202681379065);
};

function popupMemberStatusGlobals() {
    popupMemberStatus = new kony.ui.Popup({
        "addWidgets": addWidgetspopupMemberStatus,
        "id": "popupMemberStatus",
        "isModal": false,
        "skin": "frm",
