function addWidgetspopupMeetingLocation() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094197_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094197_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerMeetingLocation = new kony.ui.PickerView({
        "id": "pickerMeetingLocation",
        "isVisible": true,
        "masterData": [
            [
                ["All", "All"],
    ...
    hbox13932202681329026.add(pickerMeetingLocation);
    ...
    popupMeetingLocation.add(hboxHeaderSection, lineHeader, hbox13932202681329026, line13932202681379065);
};

function popupMeetingLocationGlobals() {
    popupMeetingLocation = new kony.ui.Popup({
        "addWidgets": addWidgetspopupMeetingLocation,
        "id": "popupMeetingLocation",
        "isModal": false,
        "skin": "frm",
