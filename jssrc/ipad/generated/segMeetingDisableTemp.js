function initializesegMeetingDisableTemp() {
    hboxMeetingDisableTemp = new kony.ui.Box({
        "id": "hboxMeetingDisableTemp",
        "isVisible": true,
    ...
    var btnReport = new kony.ui.Button({
        ...
        "id": "btnReport",
        "isVisible": true,
        "onClick": p2kwiet3578093095360_btnReport_onClick_seq0,
    ...
    var btnReopen = new kony.ui.Button({
        ...
        "id": "btnReopen",
        "isVisible": true,
        "onClick": p2kwiet3578093095360_btnReopen_onClick_seq0,
        "skin": "btnwwtxtNoMeeting",
    ...
    hboxMeetingDisableTemp.add(meetingName, vbox1296409062111705, vbox1296409062155486, vbox1296409062145431, vbox1296409062155923);
}