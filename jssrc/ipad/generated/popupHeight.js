function addWidgetspopupHeight() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093989_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093989_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pckrSelectHeight = new kony.ui.PickerView({
        "id": "pckrSelectHeight",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    hbox13932202681329026.add(pckrSelectHeight);
    ...
    popupHeight.add(hboxHeaderSection, lineHeader, hbox13932202681329026, line13932202681379065);
};

function popupHeightGlobals() {
    popupHeight = new kony.ui.Popup({
        "addWidgets": addWidgetspopupHeight,
        "id": "popupHeight",
        "isModal": false,
        "skin": "frm",
