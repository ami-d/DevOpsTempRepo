function addWidgetspopupMemberType() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094249_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094249_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerMemberType = new kony.ui.PickerView({
        "id": "pickerMemberType",
        "isVisible": true,
        "masterData": [
            [
    ...
    hbox13932202681329026.add(pickerMemberType);
    ...
    popupMemberType.add(hboxHeaderSection, lineHeader, hbox13932202681329026, line13932202681379065);
};

function popupMemberTypeGlobals() {
    popupMemberType = new kony.ui.Popup({
        "addWidgets": addWidgetspopupMemberType,
        "id": "popupMemberType",
        "isModal": false,
        "skin": "frm",
