function addWidgetspopupBMINote() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093681_vboxCancelImage_onClick_seq0,
    ...
    var lblNotes = new kony.ui.Label({
        ...
        "text": kony.i18n.getLocalizedString("strBMINotes")
    }, {
        "containerWeight": 100,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093681_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var textareaBMINote = new kony.ui.TextArea2({
    ...
    popupBMINote.add(hboxHeaderSection, textareaBMINote);
};

function popupBMINoteGlobals() {
    popupBMINote = new kony.ui.Popup({
        "addWidgets": addWidgetspopupBMINote,
        "id": "popupBMINote",
        "isModal": false,
        "skin": "frm",
