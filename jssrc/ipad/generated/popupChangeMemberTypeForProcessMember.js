function addWidgetspopupChangeMemberTypeForProcessMember() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093769_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093769_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 15,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var txtChangeMemberTypeForProcessMember = new kony.ui.TextArea2({
        "autoCapitalize": constants.TEXTAREA_AUTO_CAPITALIZE_NONE,
        "focusSkin": "txtHelvetica14pxGrey",
        "id": "txtChangeMemberTypeForProcessMember",
        "isVisible": true,
    ...
    hbox12443534676077363.add(vbox12443534676077365, txtChangeMemberTypeForProcessMember);
    popupChangeMemberTypeForProcessMember.add(hboxHeaderSection, hbox12443534676077363);
};

function popupChangeMemberTypeForProcessMemberGlobals() {
    popupChangeMemberTypeForProcessMember = new kony.ui.Popup({
        "addWidgets": addWidgetspopupChangeMemberTypeForProcessMember,
        "id": "popupChangeMemberTypeForProcessMember",
        "isModal": false,
        "skin": "frm",
