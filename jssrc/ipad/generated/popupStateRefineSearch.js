function addWidgetspopupStateRefineSearch() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094928_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094928_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 15,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerState = new kony.ui.PickerView({
        "id": "pickerState",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    popupStateRefineSearch.add(hboxHeaderSection, pickerState);
};

function popupStateRefineSearchGlobals() {
    popupStateRefineSearch = new kony.ui.Popup({
        "addWidgets": addWidgetspopupStateRefineSearch,
        "id": "popupStateRefineSearch",
        "init": p2kwiet3578093094928_popupStateRefineSearch_init_seq0,
        "isModal": false,
        "skin": "frm",
