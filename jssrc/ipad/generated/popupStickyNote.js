function addWidgetspopupStickyNote() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094938_vboxCancelImage_onClick_seq0,
    ...
    var lblNotes = new kony.ui.Label({
        ...
        "text": kony.i18n.getLocalizedString("strLblNotes")
    }, {
        "containerWeight": 100,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094938_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var textareaStickyNote = new kony.ui.TextArea2({
        "autoCapitalize": constants.TEXTAREA_AUTO_CAPITALIZE_NONE,
        "focusSkin": "txt2Focus",
        "id": "textareaStickyNote",
        "isVisible": true,
    ...
    popupStickyNote.add(hboxHeaderSection, textareaStickyNote);
};

function popupStickyNoteGlobals() {
    popupStickyNote = new kony.ui.Popup({
        "addWidgets": addWidgetspopupStickyNote,
        "id": "popupStickyNote",
        "isModal": false,
        "skin": "frm",
