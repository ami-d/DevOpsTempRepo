function addWidgetspopupSubscriptionType() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094947_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094947_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 15,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerSubType = new kony.ui.PickerView({
        "id": "pickerSubType",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    popupSubscriptionType.add(hboxHeaderSection, pickerSubType);
};

function popupSubscriptionTypeGlobals() {
    popupSubscriptionType = new kony.ui.Popup({
        "addWidgets": addWidgetspopupSubscriptionType,
        "id": "popupSubscriptionType",
        "isModal": false,
        "skin": "frm",
