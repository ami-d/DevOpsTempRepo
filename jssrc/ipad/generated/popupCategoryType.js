function addWidgetspopupCategoryType() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093692_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093692_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerCategories = new kony.ui.PickerView({
        "id": "pickerCategories",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    popupCategoryType.add(hboxHeaderSection, lineHeader, pickerCategories, line13932202681379065);
};

function popupCategoryTypeGlobals() {
    popupCategoryType = new kony.ui.Popup({
        "addWidgets": addWidgetspopupCategoryType,
        "id": "popupCategoryType",
        "isModal": true,
        "skin": "frm",
