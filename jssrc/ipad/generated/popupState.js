function addWidgetspopupState() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094919_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094919_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 15,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    popupState.add(hboxHeaderSection, pickerState);
};

function popupStateGlobals() {
    popupState = new kony.ui.Popup({
        "addWidgets": addWidgetspopupState,
        "id": "popupState",
        "init": p2kwiet3578093094919_popupState_init_seq0,
        "isModal": false,
        "skin": "frm",
