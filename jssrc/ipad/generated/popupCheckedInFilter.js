function addWidgetspopupCheckedInFilter() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093820_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093093820_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var pickerCheckedInMember = new kony.ui.PickerView({
        "id": "pickerCheckedInMember",
        "isVisible": true,
        "masterData": [
            [
                ["0", kony.i18n.getLocalizedString("strAll")],
                ["1", kony.i18n.getLocalizedString("tabMilestones")],
                ["2", kony.i18n.getLocalizedString("strIncompleteProfile")], 100
            ]
        ],
        "masterDataMap": null,
    ...
    hbox13932202681329026.add(pickerCheckedInMember);
    ...
    popupCheckedInFilter.add(hboxHeaderSection, lineHeader, hbox13932202681329026, line13932202681379065);
};

function popupCheckedInFilterGlobals() {
    popupCheckedInFilter = new kony.ui.Popup({
        "addWidgets": addWidgetspopupCheckedInFilter,
        "id": "popupCheckedInFilter",
        "isModal": true,
        "skin": "frm",
