function addWidgetspopupQuantityPicker() {
    ...
    var vboxCancelImage = new kony.ui.Box({
        "id": "vboxCancelImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094767_vboxCancelImage_onClick_seq0,
    ...
    var vboxDoneImage = new kony.ui.Box({
        "id": "vboxDoneImage",
        "isVisible": true,
        "onClick": p2kwiet3578093094767_vboxDoneImage_onClick_seq0,
        "orientation": constants.BOX_LAYOUT_VERTICAL
    }, {
        "containerWeight": 14,
        "layoutType": constants.CONTAINER_LAYOUT_BOX,
    ...
    var quantityPicker = new kony.ui.PickerView({
        "id": "quantityPicker",
        "isVisible": true,
        "masterData": [],
        "masterDataMap": null,
    ...
    popupQuantityPicker.add(hboxHeaderSection, lineHeader, quantityPicker, line13932202681379065);
};

function popupQuantityPickerGlobals() {
    popupQuantityPicker = new kony.ui.Popup({
        "addWidgets": addWidgetspopupQuantityPicker,
        "id": "popupQuantityPicker",
        "isModal": false,
        "skin": "frm",
