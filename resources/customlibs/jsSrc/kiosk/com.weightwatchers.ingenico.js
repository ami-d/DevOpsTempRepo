...
this.initiazeDevice= function(baseURL,apiKey,clientVersion,userName,password,pairCallBack,connCallback,isConnInBG,isRepairingRequest,batteryCallback){};
...
this.saveDeviceDetailTOKeychain= function(deviceName,deviceIdentifier){};
this.resetPairing= function(){};
this.getDeviceDetailFromKeychain= function(deviceInfoCallbackObj){};
};
