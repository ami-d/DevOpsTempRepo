...
var syncErrorCode =[
	{"errorCode" : "SY3001E","errorMessage" : "The App version is not the latest one. Please upgrade the application."},
	{"errorCode" : "SY3002E","errorMessage" : "The App version is not the latest one. Please Reinstall the application."}
];



var listOfServicesNotDisplayLoading = [
	"runTransaction",
	"PeripheralStatusLog",
	"ActivityLogInsert",
	"SaleReceiptREST",
...
var appVersionDetails = "10.0.1 | 24-FEB-2016";


function callMemberWeightAndMilestone(memberID) {
    try {
        ...
        MemberWeightAndMilestoneHandle = Network.makeServiceCall(MemberWeightAndMilestone_inputparam, getMemberWeightAndMilestoneWSCallback, true); //true to allow offline data access
...
{
	if(obj != undefined)
		kony.print(lbl+" ==> "+JSON.stringify(obj));
	else 
		kony.print(lbl);
}

var arrSubtype = [
	"Monthly Pass-Buy New",
	"Monthly Pass-Redeem",
	"3 Months Pass - Buy",
	"6 Months Pass - Buy",
	"12 Months Pass - Buy",
