...
function onEndEditingForSubID() {
    var subID;
    if (IsPreActivation == FlowForScreens.PreActivation && deviceLocale == Countries["US"]) {
    ...
    if (subTypeText != SubTypeKeyValues[0][1]) {
        ...
        switch (SubTypeKeyValues[0][1]) {
            ...
            case kony.i18n.getLocalizedString("strLTC12"): //** MEG 6434
                isPayAsYouGo = false;
                if (in_array(deviceLocale, Countries["US"]) && (in_array(SubTypeKeyValues[0][1], [kony.i18n.getLocalizedString("strMPBuyNew"), kony.i18n.getLocalizedString("str3MPBuy"), kony.i18n.getLocalizedString("str6MPBuy"), kony.i18n.getLocalizedString("strLTC6"), kony.i18n.getLocalizedString("strLTC12")]))) { //** MEG 6434
                    glbFormName.txtSubscriptionID.setEnabled(false);
                    glbFormName.imgsub.isVisible = false;
                    glbFormName.btnScan.setVisibility(false);
