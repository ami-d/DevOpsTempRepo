...
// ****************Generated On Thu May 18 12:35:27 IST 2017WeighDetails*******************
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.create = function(valuestable, successcallback,errorcallback,markForUpload){
	...
	if(kony.sync.enableORMValidations){
		...
		pks["WeekNumber"] = {key:"WeekNumber",value:valuestable.WeekNumber};
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.deleteByPK = function(pks, successcallback,errorcallback, markForUpload){
	...
	function WeighDetailsTransactionCallback(tx){
		...
		if (null !== record) {
			if(!kony.sync.removeCascadeHelper(tx, "WeekNumber", "WeekNumber", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade,"MilestoneAchieved",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	function WeighDetails_removeTransactioncallback(tx){
		wcs = " " + wcs;
		if(!kony.sync.removeCascadeHelper(tx, "WeekNumber", "WeekNumber", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeDeviceInstanceByPK = function(pks, successcallback,errorcallback){
	...
	function WeighDetailsTransactionCallback(tx){
		...
		if(null !== record && false !=record) {
			...
			if(!kony.sync.removeCascadeHelper(tx, "WeekNumber", "WeekNumber", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade,"MilestoneAchieved",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeDeviceInstance = function(wcs, successcallback,errorcallback){
	...
	function WeighDetails_removeTransactioncallback(tx){
		wcs = " " + wcs;
		if(!kony.sync.removeCascadeHelper(tx, "WeekNumber", "WeekNumber", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
* with given WeekNumber from local database.
*************************************************************************************/
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.prototype.getMilestoneAchievedWithWeekNumber  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.WeightWatchers.MemberSyncScope.WeighDetails.prototype.getMilestoneAchievedWithWeekNumber function");
	var pks = this.getPKTable();
	com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getMilestoneAchievedWithWeekNumber(pks,successcallback,errorcallback);
};
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getMilestoneAchievedWithWeekNumber = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getMilestoneAchievedWithWeekNumber function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getMilestoneAchievedWithWeekNumber",  "relationship", errorcallback)){
		return;
	}	
	function WeighDetails_successcallback(res){
		if(null!==res && res.length>0) {
			var targetKey = res[0].WeekNumber;
			var wcs = "" ;
			if(kony.type(targetKey)==="string") {
				wcs = "where WeekNumber = '" + targetKey + "'";
			}else{
				wcs = "where WeekNumber = " + targetKey ;
			}
...
* with given WeekNumber from local database.
*************************************************************************************/
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.prototype.getCountOfMilestoneAchievedWithWeekNumber  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.WeightWatchers.MemberSyncScope.WeighDetails.prototype.getCountOfMilestoneAchievedWithWeekNumber function");
	var pks = this.getPKTable();
	com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getCountOfMilestoneAchievedWithWeekNumber(pks,successcallback,errorcallback);
};
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getCountOfMilestoneAchievedWithWeekNumber = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getCountOfMilestoneAchievedWithWeekNumber function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getCountOfMilestoneAchievedWithWeekNumber",  "relationship", errorcallback)){
		return;
	}
	function WeighDetails_successcallback(res){
		if(null!==res && res.length>0) {
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade = function(tx, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal){
	...
	function removeCascadeChildren(){
		if(!kony.sync.removeCascadeHelper(tx, "WeekNumber", "WeekNumber", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
	}
	if(isCascade){
...
com.kony.WeightWatchers.MemberSyncScope.WeighDetails.prototype.getPKTable = function(){
	...
	var pkTable = {};
	pkTable.WeekNumber = {key:"WeekNumber",value:this.WeekNumber};
