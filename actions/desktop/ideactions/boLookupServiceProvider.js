            ...
            try {
                if (status == 400) {
                    if (GetEmpByNameOrNumberResult["opstatus"] == 0) {
                        ...
                        if (GetEmpByNameOrNumberResult["EmployeeList"].length > 0) {
			...
			try{
				if(status === 400){
					if(GetWeightDataOfEmployeeResult['opstatus'] == 0){
						...
						if (GetWeightDataOfEmployeeResult != null && GetWeightDataOfEmployeeResult != undefined && GetWeightDataOfEmployeeResult["MemberWeightList"] != null && GetWeightDataOfEmployeeResult["MemberWeightList"] != undefined) {
							if(GetWeightDataOfEmployeeResult['MemberWeightList'].length > 0){
