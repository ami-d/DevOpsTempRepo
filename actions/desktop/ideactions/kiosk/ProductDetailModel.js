...
// ****************Generated On Thu May 18 12:35:24 IST 2017ProductDetail*******************
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.create = function(valuestable, successcallback, errorcallback, markForUpload) {
    ...
    if (kony.sync.enableORMValidations) {
        ...
        pks["ProductID"] = {
            key: "ProductID",
            value: valuestable.ProductID
        };
        errMsg = errMsg + ", LocationID=" + valuestable.LocationID;
        pks["LocationID"] = {
            key: "LocationID",
            value: valuestable.LocationID
        };
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.deleteByPK = function(pks, successcallback, errorcallback, markForUpload) {
    ...
    function ProductDetailTransactionCallback(tx) {
        ...
        if (null !== record) {
            if (!kony.sync.removeCascadeHelper(tx, "ProductID", "ProductID", tbname, "", com.kony.WeightWatchers.ProductSyncScope.OfferDetail.removeCascade, "OfferDetail", true, errorcallback, markForUpload, record, false)) {
                isError = true;
                kony.sync.rollbackTransaction(tx);
                return;
            }
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.remove = function(wcs, successcallback, errorcallback, markForUpload) {
    ...
    function ProductDetail_removeTransactioncallback(tx) {
        wcs = " " + wcs;
        if (!kony.sync.removeCascadeHelper(tx, "ProductID", "ProductID", tbname, wcs, com.kony.WeightWatchers.ProductSyncScope.OfferDetail.removeCascade, "OfferDetail", true, errorcallback, markForUpload, null, false)) {
            isError = true;
            kony.sync.rollbackTransaction(tx);
            return;
        }
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.removeDeviceInstanceByPK = function(pks, successcallback, errorcallback) {
    ...
    function ProductDetailTransactionCallback(tx) {
        ...
        if (null !== record && false != record) {
            ...
            if (!kony.sync.removeCascadeHelper(tx, "ProductID", "ProductID", tbname, "", com.kony.WeightWatchers.ProductSyncScope.OfferDetail.removeCascade, "OfferDetail", true, errorcallback, null, record, true)) {
                isError = true;
                kony.sync.rollbackTransaction(tx);
                return;
            }
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.removeDeviceInstance = function(wcs, successcallback, errorcallback) {
    ...
    function ProductDetail_removeTransactioncallback(tx) {
        wcs = " " + wcs;
        if (!kony.sync.removeCascadeHelper(tx, "ProductID", "ProductID", tbname, wcs, com.kony.WeightWatchers.ProductSyncScope.OfferDetail.removeCascade, "OfferDetail", true, errorcallback, null, null, true)) {
            isError = true;
            kony.sync.rollbackTransaction(tx);
            return;
        }
    ...
    function ProductDetail_successcallback(res) {
        if (null !== res && res.length > 0) {
            ...
            if (kony.type(targetKey) === "string") {
                wcs = "where ProductID = '" + targetKey + "'";
            } else {
                wcs = "where ProductID = " + targetKey;
            }
            com.kony.WeightWatchers.ProductSyncScope.OfferDetail.find(wcs, mySuccesscallback, errorcallback);
        } else {
            kony.sync.verifyAndCallClosure(successcallback);
            return;
        }
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.getCountOfOfferDetailWithProductID = function(pks, successcallback, errorcallback) {
    ...
    function ProductDetail_successcallback(res) {
        if (null !== res && res.length > 0) {
            ...
            com.kony.WeightWatchers.ProductSyncScope.OfferDetail.getCount(wcs, successcallback, errorcallback);
        } else {
            kony.sync.verifyAndCallClosure(successcallback, {
                "count": 0
            });
...
com.kony.WeightWatchers.ProductSyncScope.ProductDetail.removeCascade = function(tx, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal) {
    ...
    function removeCascadeChildren() {
        if (!kony.sync.removeCascadeHelper(tx, "ProductID", "ProductID", tbname, wcs, com.kony.WeightWatchers.ProductSyncScope.OfferDetail.removeCascade, "OfferDetail", true, errorcallback, markForUpload, null, isLocal)) {
            return false;
        }
    }
    if (isCascade) {
