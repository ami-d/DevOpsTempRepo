var boProcessMember = {
        ...
        function getMemberLoosingWeightRapidlyCallBack(res) {
            ...
            if (res != null && res.length == limitCount) {
                ...
                if ((parseInt(kony.sync.getString(res[0].Weight)) - currentWeight) > 2) {
                    ...
                    if (((weekNumber0 - weekNumber1) == 1 || (weekNumber0 - weekNumber1) == -51) && (weight1 - weight0) > 2 && ((weekNumber1 - weekNumber2) == 1 || (weekNumber1 - weekNumber2) == -51) && (weight2 - weight1) > 2) {
                        isFlag = true;
    ...
    checkForMemberInMaintainace: function(memberId, checkMemberInMaintainenceSucessCallback) {
        ...
        function checkMemberISInMaintainenceCallback(res) {
            ...
            if (res.length > 0) {
                var v = res[0];
                if (kony.sync.getString(v.MaintenanceMode) != null) glbIsInMaintance = kony.sync.getString(v.MaintenanceMode);
