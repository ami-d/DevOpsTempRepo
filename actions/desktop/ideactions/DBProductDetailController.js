var DBProductDetailController = {
    find: function(wcs, successcallback, errorcallback) {
        wcs = wcs.replace("where ", "where CountryID='" + getCountryID() + "' AND ");
        com.kony.WeightWatchers.ProductSyncScope.ProductDetail.find(wcs, successcallback, errorcallback);
    },
    create: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.ProductSyncScope.ProductDetail.create(obj, successcallback, errorcallback, markForUpload);
    },
    createAll: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.ProductSyncScope.ProductDetail.createAll(obj, successcallback, errorcallback, markForUpload);
    },
    update: function(wcs, obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.ProductSyncScope.ProductDetail.update(wcs, obj, successcallback, errorcallback, markForUpload);
    }
}
