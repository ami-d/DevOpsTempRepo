...
// ****************Generated On Thu May 18 12:35:24 IST 2017OfferDetail*******************
...
com.kony.WeightWatchers.ProductSyncScope.OfferDetail.getRelationshipMap = function(relationshipMap, valuestable) {
    ...
    var r1 = {};
    if (!kony.sync.isNull(valuestable.ProductID)) {
        if (relationshipMap.ProductDetail === undefined) {
            relationshipMap.ProductDetail = [];
        }
        r1 = {};
        r1.sourceAttribute = "ProductID";
        r1.foreignKeyAttribute = "ProductID";
        r1.targetAttributeValue = valuestable.ProductID;
