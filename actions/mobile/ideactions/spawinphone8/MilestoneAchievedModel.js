...
// ****************Generated On Thu May 18 12:35:28 IST 2017MilestoneAchieved*******************
 ...
 *		valuesArray[0].MemberMilestoneID = "MemberMilestoneID_0";
 ...
 *		valuesArray[1].MemberMilestoneID = "MemberMilestoneID_1";
 ...
 *		valuesArray[2].MemberMilestoneID = "MemberMilestoneID_2";
    ...
    if (kony.sync.enableORMValidations) {
        ...
        function checkDuplicatePkCallback(tx) {
            ...
            for (var i = 0; valuesArray != null && i < arrayLength; i++) {
                ...
                pks["MemberMilestoneID"] = {
                    key: "MemberMilestoneID",
                    value: valuestable.MemberMilestoneID
                };
...
com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.filterAttributes = function(valuestable, insert) {
    ...
    PKTable.MemberMilestoneID.isAutoGen = false;
    PKTable.ID = {}
    PKTable.ID.name = "ID";
...
com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.validateNullInsert = function(valuestable, errorcallback) {
    ...
    if (kony.sync.isNull(valuestable.MemberMilestoneID) || kony.sync.isEmptyString(valuestable.MemberMilestoneID)) {
        sync.log.error("Mandatory attribute MemberMilestoneID is missing for the SyncObject MilestoneAchieved.");
        errorcallback(kony.sync.getErrorTable(kony.sync.errorCodeMandatoryAttribute, kony.sync.getErrorMessage(kony.sync.errorCodeMandatoryAttribute, "MilestoneAchieved", "MemberMilestoneID")));
        return false;
    }
    return true;
};
com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.getRelationshipMap = function(relationshipMap, valuestable) {
    ...
    if (!kony.sync.isNull(valuestable.WeekNumber)) {
        if (relationshipMap.WeighDetails === undefined) {
            relationshipMap.WeighDetails = [];
        }
        r1 = {};
        r1.sourceAttribute = "WeekNumber";
        r1.foreignKeyAttribute = "WeekNumber";
        r1.targetAttributeValue = valuestable.WeekNumber;
