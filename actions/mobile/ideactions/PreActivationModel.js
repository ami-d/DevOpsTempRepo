...
// ****************Generated On Thu May 18 12:35:28 IST 2017PreActivation*******************
...
*		valuesArray[0].ActivationDate = "ActivationDate_0";
*		valuesArray[0].MeetingDate = 0;
*		valuesArray[0].ActivationStatus = "ActivationStatus_0";
...
*		valuesArray[1].ActivationDate = "ActivationDate_1";
*		valuesArray[1].MeetingDate = 1;
*		valuesArray[1].ActivationStatus = "ActivationStatus_1";
...
*		valuesArray[2].ActivationDate = "ActivationDate_2";
*		valuesArray[2].MeetingDate = 2;
*		valuesArray[2].ActivationStatus = "ActivationStatus_2";
	...
	if(kony.sync.enableORMValidations){
		...
		function checkDuplicatePkCallback(tx){
			...
			var valuestable = valuesArray[i];
				...
				pks["ActivationDate"] = {key:"ActivationDate",value:valuestable.ActivationDate};
				errMsg = errMsg + ", ActivationStatus=" + valuestable.ActivationStatus;
				pks["ActivationStatus"] = {key:"ActivationStatus",value:valuestable.ActivationStatus};
				errMsg = errMsg + ", CouponCode=" + valuestable.CouponCode;
				pks["CouponCode"] = {key:"CouponCode",value:valuestable.CouponCode};
...
com.kony.WeightWatchers.MemberSyncScope.PreActivation.filterAttributes = function(valuestable, insert){
	...
	PKTable.ActivationDate.isAutoGen = false;
	PKTable.ActivationStatus = {}
	PKTable.ActivationStatus.name = "ActivationStatus";
	PKTable.ActivationStatus.isAutoGen = false;
	var newvaluestable = {};
...
com.kony.WeightWatchers.MemberSyncScope.PreActivation.prototype.getPKTable = function(){
	...
	pkTable.ActivationDate = {key:"ActivationDate",value:this.ActivationDate};
	pkTable.ActivationStatus = {key:"ActivationStatus",value:this.ActivationStatus};
	pkTable.CouponCode = {key:"CouponCode",value:this.CouponCode};
...
com.kony.WeightWatchers.MemberSyncScope.PreActivation.validateNullInsert = function (valuestable,errorcallback){
	...
	if(kony.sync.isNull(valuestable.ActivationDate) || kony.sync.isEmptyString(valuestable.ActivationDate)){
		sync.log.error("Mandatory attribute ActivationDate is missing for the SyncObject PreActivation.");
		errorcallback(kony.sync.getErrorTable(kony.sync.errorCodeMandatoryAttribute,kony.sync.getErrorMessage(kony.sync.errorCodeMandatoryAttribute, "PreActivation", "ActivationDate")));
		return false;
	}
	if(kony.sync.isNull(valuestable.ActivationStatus) || kony.sync.isEmptyString(valuestable.ActivationStatus)){
		sync.log.error("Mandatory attribute ActivationStatus is missing for the SyncObject PreActivation.");
		errorcallback(kony.sync.getErrorTable(kony.sync.errorCodeMandatoryAttribute,kony.sync.getErrorMessage(kony.sync.errorCodeMandatoryAttribute, "PreActivation", "ActivationStatus")));
		return false;
	}
