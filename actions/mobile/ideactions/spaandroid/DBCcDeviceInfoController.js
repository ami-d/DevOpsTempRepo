var DBCcDeviceInfoController = {
    find: function(wcs, successcallback, errorcallback) {
        // wcs = wcs.replace("where ","where CountryID='"+getCountryID()+"' AND ");
        wcs = wcs.replace("where ", "where CountryID='" + getCountryID() + "' AND ");
        com.kony.WeightWatchers.Logger.CcDeviceInfo.find(wcs, successcallback, errorcallback);
    },
    create: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.Logger.CcDeviceInfo.create(obj, successcallback, errorcallback, markForUpload);
    },
    createAll: function(obj, successcallback, errorcallback, markForUpload) {
        ...
        com.kony.WeightWatchers.Logger.CcDeviceInfo.createAll(obj, successcallback, errorcallback, markForUpload);
    },
    update: function(wcs, obj, successcallback, errorcallback, markForUpload) {
        ...
        wcs = wcs.replace("where ", "where CountryID='" + getCountryID() + "' AND ");
        kony.print("::PK:: ----" + wcs);
        com.kony.WeightWatchers.Logger.CcDeviceInfo.update(wcs, obj, successcallback, errorcallback, markForUpload);
    }
}