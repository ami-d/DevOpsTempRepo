...
// ****************Generated On Thu May 18 12:35:27 IST 2017MemberDetails*******************
	...
	if(kony.sync.enableORMValidations){
		...
		function checkDuplicatePkCallback(tx){
			...
			var valuestable = valuesArray[i];
				...
				pks["PreRegNumber"] = {key:"PreRegNumber",value:valuestable.PreRegNumber};
				var wcs = [];
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.deleteByPK = function(pks, successcallback,errorcallback, markForUpload){
	...
	function MemberDetailsTransactionCallback(tx){
		...
		if (null !== record) {
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade,"WeighDetails",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade,"MilestoneAchieved",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.removeCascade,"MilestoneEligible",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.NoteDetails.removeCascade,"NoteDetails",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.removeCascade,"RefferalDetails",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.SaleDetails.removeCascade,"SaleDetails",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.PreActivation.removeCascade,"PreActivation",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	function MemberDetails_removeTransactioncallback(tx){
		wcs = " " + wcs;
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade, "WeighDetails", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.removeCascade, "MilestoneEligible", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.NoteDetails.removeCascade, "NoteDetails", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.removeCascade, "RefferalDetails", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.SaleDetails.removeCascade, "SaleDetails", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.PreActivation.removeCascade, "PreActivation", false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.removeDeviceInstanceByPK = function(pks, successcallback,errorcallback){
	...
	function MemberDetailsTransactionCallback(tx){
		...
		if(null !== record && false !=record) {
			...
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade,"WeighDetails",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade,"MilestoneAchieved",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.removeCascade,"MilestoneEligible",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.NoteDetails.removeCascade,"NoteDetails",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.removeCascade,"RefferalDetails",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.SaleDetails.removeCascade,"SaleDetails",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, "", com.kony.WeightWatchers.MemberSyncScope.PreActivation.removeCascade,"PreActivation",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.removeDeviceInstance = function(wcs, successcallback,errorcallback){
	...
	function MemberDetails_removeTransactioncallback(tx){
		wcs = " " + wcs;
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade, "WeighDetails", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.removeCascade, "MilestoneEligible", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.NoteDetails.removeCascade, "NoteDetails", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.removeCascade, "RefferalDetails", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.SaleDetails.removeCascade, "SaleDetails", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.PreActivation.removeCascade, "PreActivation", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			if(kony.type(targetKey)==="string") {
				wcs = "where MemberID = '" + targetKey + "'";
			}else{
				wcs = "where MemberID = " + targetKey ;
			}
			com.kony.WeightWatchers.MemberSyncScope.WeighDetails.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfWeighDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.WeighDetails.getCount(wcs, successcallback,errorcallback);
		}else{
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getMilestoneAchievedWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfMilestoneAchievedWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getMilestoneEligibleWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfMilestoneEligibleWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getNoteDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.NoteDetails.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfNoteDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.NoteDetails.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getRefferalDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfRefferalDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getSaleDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.SaleDetails.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfSaleDetailsWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.SaleDetails.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getPreActivationWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.PreActivation.find(wcs, mySuccesscallback,errorcallback);
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.getCountOfPreActivationWithMemberID = function(pks,successcallback,errorcallback){
	...
	function MemberDetails_successcallback(res){
		if(null!==res && res.length>0) {
			...
			com.kony.WeightWatchers.MemberSyncScope.PreActivation.getCount(wcs, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.removeCascade = function(tx, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal){
	...
	function removeCascadeChildren(){
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.WeighDetails.removeCascade, "WeighDetails", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneAchieved.removeCascade, "MilestoneAchieved", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.MilestoneEligible.removeCascade, "MilestoneEligible", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.NoteDetails.removeCascade, "NoteDetails", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.RefferalDetails.removeCascade, "RefferalDetails", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.SaleDetails.removeCascade, "SaleDetails", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
		if(!kony.sync.removeCascadeHelper(tx, "MemberID", "MemberID", tbname, wcs, com.kony.WeightWatchers.MemberSyncScope.PreActivation.removeCascade, "PreActivation", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
	}
	if(isCascade){
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.filterAttributes = function(valuestable, insert){
	...
	PKTable.MemberID.isAutoGen = true;
	var newvaluestable = {};
...
com.kony.WeightWatchers.MemberSyncScope.MemberDetails.prototype.getPKTable = function(){
	...
	pkTable.PreRegNumber = {key:"PreRegNumber",value:this.PreRegNumber};
	return pkTable;
};
